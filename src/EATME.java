...
private void makeAlbum() {
  	// 1. Find 4 images of fo ods eaten by different utensils and put them in
	// your default package
	// 2. Connect the images to the UP, DOWN, LEFT, and RIGHT keys like
	// this...
	images.put(new Integer(KeyEvent.VK_UP), "imgres.jpg"); // the spoon will be connected to the UP key
	images.put(new Integer(KeyEvent.VK_LEFT), "imgres-3.jpg"); // the chopstick will be connected to the LEFT key
...
public void keyPressed(KeyEvent e) {
	...
	// 11. Otherwise, tell the user that they should learn some manners
		...
		JOptionPane.showInputDialog("You should learn some manners ");
